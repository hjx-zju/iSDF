...
class EntropyLeNet(nn.Module):
    ...
    def get_decompressed_parameters(self):
        fc1_params = self.fc1.get_decompressed_parameters()
        fc2_params = self.fc2.get_decompressed_parameters()
        fc3_params = self.fc3.get_decompressed_parameters()
...
if __name__ == "__main__":
    model = EntropyLeNet()
    # print(model.get_entropy_parameters())   
